...
["Tyrell", `Margaery Tyrell became Queen Consort through her marriage to Joffrey Baratheon, and later Tommen Baratheon. She was eventually killed along with her brother and father when the Great Sept of Baelor was destroyed with wildfire as orchestrated by Cersei Lannister to reclaim her lost power. `]
...
debugger;
   ...
   function closeLightBox(){
    ...
    function showHouseData(targetIndex){
      debugger;
      houseName.textContent = ` ${houseData[targetIndex][0]}`;
